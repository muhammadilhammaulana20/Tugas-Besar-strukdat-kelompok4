"""
adeganteng_fixed.py
- Perbaikan kode player
- Playlist permanen (playlist.json)
- Progress bar (waktu berjalan + total)
- Next/Prev mengikuti urutan tampilan (agar Next melompat ke baris bawah)
- Prev/Next tersedia di Admin page
"""
...
class MusicPlayer:
    ...
    def __init__(self):
        ...
        # list_order dictates the visual order:
        # 'asc' returns library.get_all() as-is (older->newer)
        # 'desc' returns reversed (newest->oldest) — used in Trending (home)
        self.list_order = "asc"
...
class AdminController:
    """Contains operations that an admin can perform on the player/library."""
